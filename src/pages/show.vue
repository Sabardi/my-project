      ...
      <div class="flex flex-wrap mx-auto lg:w-4/5">
        ...
        <div class="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
          ...
          <div class="flex">
            ...
            <button
              class="flex px-6 py-2 ml-auto text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">buy
            </button>
            <button.
...
onMounted(async () => {
  const response = await fetch(`https://fakestoreapi.com/products/${route.params.products}`);
